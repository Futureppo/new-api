...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"registration_code_required":         setting.GetEnhancementSetting().RegistrationCodeRequired,
		"registration_code_force_active":     setting.IsRegistrationCodeForceActive(),
		"registration_code_force_start_time": setting.GetEnhancementSetting().RegistrationCodeForceStartTime,
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	if model.IsEmailAlreadyTaken(email) {
		...
		err := service.SendEmailWithLog(c, 0, "password_reset", subject, email, content)
		if err != nil {
