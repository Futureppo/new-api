...
func TestReasoningEffortRequestPipeline(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "override after suffix", channel: constant.ChannelTypeOpenAI, model: "gpt-5-high", body: `{"reasoning_effort":"low"}`, override: map[string]any{"reasoning_effort": "xhigh"}, field: "reasoning_effort", want: "xhigh"},
		...
		{name: "responses override", channel: constant.ChannelTypeOpenAI, model: "gpt-5", format: types.RelayFormatOpenAIResponses, body: `{"reasoning":{"effort":"low"}}`, override: map[string]any{"reasoning": map[string]any{"effort": "xhigh"}}, field: "reasoning.effort", want: "xhigh"},
		...
		{name: "chat to responses", channel: constant.ChannelTypeOpenAI, model: "gpt-5", body: `{"reasoning_effort":"low"}`, viaResponses: true, override: map[string]any{"reasoning_effort": "xhigh"}, field: "reasoning.effort", want: "xhigh"},
